...
const shell=new THREE.Shape(); shell.curves=outline(0).curves; shell.holes.push(outline(W,W+0.01)); // inner wall-side face 1 cm off the tile plane (x0+0.05 = tile face), else the tile z-fights through
