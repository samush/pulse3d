...
add(rbox(0.45,0.06,0.45,0.02,0.05,0.40,0.05,{m:2,step:0.1,crown:0.01}),'fabric');    // seat cushion 0.40–0.46
...
add(rbox(0.05,0.36,0.40,0.02,0,0,0,{m:2,step:0.1}).rotateZ(-tilt).translate(0.465,0.48,0.075),'fabric');
