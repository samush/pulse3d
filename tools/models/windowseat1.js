// Window seat 0.75×0.65×1.89 in room 1 (tasks/realism-all/PLAN.md §8): body with a recessed plinth, a radiator grille east (x=0.75),
...
add(rbox(0.73,0.40,L,0.005,0,0.05,0,{m:1,step:0.3}),'body');                          // body 0.05–0.45
grille(0.74,0.06,0.44,0.01,L-0.01,'wdoor');                                           // front grille east instead of drawers: air from the radiator under the sill
add(rbox(0.73,0.08,L-0.04,0.03,0,0.45,0.02,{m:2,step:0.1,crown:0.01}),'kmat');       // mattress 0.45–0.53
[0.05,L-0.35].forEach(z=>add(rbox(0.40,0.11,0.30,0.05,0.175,0.53,z,{m:2,step:0.1,crown:0.01}),'pillow')); // pillows, top ≤ 0.65
