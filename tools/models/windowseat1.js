// Window seat 0.60×0.65×1.89 in room 1 (tasks/realism-all/PLAN.md §8): body with a recessed plinth, a radiator grille east (x=0.60),
...
grille(0.59,0.06,0.44,0.01,L-0.01,'wdoor');                                           // front grille east instead of drawers: air from the radiator under the sill
