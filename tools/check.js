...
(async () => {
  ...
  const glbD = await page.evaluate(async () => { const want = { mbed: ['1.8,1.1,2.82', 'fabric,leather', 6], vpouf: ['0.4,0.45,0.4', 'leather,metal', 5] }, bad = [];
  ...
  const M4 = { hall5: { items: [['wardrobe', 'door', 'cabinetPaint'], ['wardrobe', 'body', 'cabinetPaint'], ['wardrobe', 'hdark', 'class'], ['entry', 'door', 'cabinetPaint'], ['sw5', 'plastic', 'plastic'], ['pouf', 'glb:leather', 'class']], pose: [9.1, 6.6, 9.1, 7.7] },
    laundry7: { items: [['washer', 'glb:plastic', 'plastic'], ['washer', 'glb:paint', 'whiteEnamel'], ['washer', 'glb:chrome', 'class']], finish: [['white', 'tile6060']], pose: [7.6, 3.7, 7.35, 2.6] },
