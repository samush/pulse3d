...
(async () => {
  ...
  const glbD = await page.evaluate(async () => { const want = { mbed: ['1.7,1.1,2.2', 'fabric,leather', 7], vpouf: ['0.4,0.45,0.4', 'leather,metal', 5] }, bad = [];
