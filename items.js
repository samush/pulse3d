...
(function(){
  ...
  const ITEMS=[
    ...
    {id:'sofa',type:'диван 2 м, низкий, без спинки и подлокотников, три большие подушки',room:4,layer:'kitchen',pos:[11.35,6.287-0.9],rot:0,size:[2.0,0.85,0.88],glb:'models/sofa.glb',coat:{upholstery:'sofaWeave',piping:'sofaWeave',cushion:'sofaWeave'}, // model by tools/models/sofa.js
     build(b){ b.phys(0,2,0.1,0.85,0,0.88); b(0,2,0.05,0.42,0,0.88,mat.sofa); [0.1,0.7,1.3].forEach(x=>b(x,x+0.6,0.42,0.85,0.60,0.78,mat.cushion)); }}, // fallback: seat block and three pillows
