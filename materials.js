...
const COATINGS={
  ...
  beigeFront: {name:'фасад бежевый в цвет плитки, слабый рисунок дерева', class:'wood', dir:'textures/oakFurniture', size:[1.83,1.83], maps:['normal','rough'], color:0xd1c4b1, normalScale:0.22}, // 2026-09-11: навесные шкафы кухни — тон плитки пола (среднее по textures/tile60120), albedo-карта снята, рисунок остаётся только рельефом
