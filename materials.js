...
const MATERIALS={
  ...
  bathWall: {name:'плитка санузлов 30×60 вертикально, белый мрамор со швами', size:[0.3,0.6], rough:0.3, bump:0.06}, // no photo coating: the concept canvas keeps the grout grid the tile6060 map lacks
