...
const COATINGS={
  ...
  oakOrange:  {name:'фасад рыжий, слабый рисунок дерева', class:'wood', dir:'textures/oakFurniture', size:[1.83,1.83], maps:['normal','rough'], color:0xef7d25, normalScale:0.22}, // 2026-09-11: навесные шкафы кухни F–I — albedo-карта снята, рисунок остаётся только рельефом, чтобы число дверц читалось
